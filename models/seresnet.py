...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, reduction=1):
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, num_block=0):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, reduction = self.args.reduction))
